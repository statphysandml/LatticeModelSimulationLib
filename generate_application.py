...
parser.add_argument("-n", "--project_name", help="The name of the project.", type=str, default="my-lattice-model-simulation-project")
...
cookiecutter(
    ...
    extra_context={
        'path_to_lattice_model_simulation_lib': os.path.dirname(os.path.realpath(__file__)),
