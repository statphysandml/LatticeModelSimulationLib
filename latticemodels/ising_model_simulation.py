...
from ising_model_simulation import IsingModel
...
if __name__ == "__main__":
    ...
    mode_simulation = ModeSimulation(model=ising_model,
        ...
        running_parameter_kind="model_params", running_parameter="beta",
        rp_minimum=0.4, rp_maximum=0.6, rp_number=2
    )

    # mode_simulation.equilibrium_time_simulation(run=True, eval=True, sample_size=20, number_of_steps=5000, eval_confidence_range=0.1,
    #     eval_confidence_window=100, measure="Mean")
    #
    # mode_simulation.compute_equilibrium_time(from_file=True, fma=fma)  # -> uses rel_data_path and rp_minimum to load parameters
    #
    # mode_simulation.correlation_time_simulation(run=True, eval=False, minimum_sample_size=100, maximum_correlation_time=1000,
    ...
    #
    # mode_simulation.expectation_value_simulation(run=True, eval=False, correlation_time_rel_results_path="./data/Test/results/",
    #     number_of_measurements=10000, equilibrium_time_rel_results_path="./data/Test/results/", measures=["Mean", "Config"]
    # )
    #
