...
void custom_main()
{
    ...
    // c)
    // By running:
    //     ./LatticeModelSimulationTemplate expectation_value ONModelMetropolis
...
// Rerun the simulation with ./LatticeModelSimulationTemplate expectation_value ONModelMetropolis
